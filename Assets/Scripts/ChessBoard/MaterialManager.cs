...
public class MaterialManager : MonoBehaviour {
    ...
    // Chức năng: Thay đổi "lớp da" (Material) của một quân cờ 3D dựa trên loại (Vua/Hậu...) và màu (Trắng/Đen).
    // Ví dụ: Nếu là Tốt Đen -> Gán material PawnBlack.
    public GameObject changeMaterial(GameObject Piece, ChessType chessType, ChessColor color)
    {
        switch (chessType) 
        {
            case ChessType.Bishop:
                // Tìm Component SkinnedMeshRenderer (lưới 3D) và gán material mới
